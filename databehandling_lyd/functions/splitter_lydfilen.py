...
def split_audio_by_detection(detections_df: pd.DataFrame, output_base_dir_path: Path):
    ...
    MAX_SEGMENTS_PER_SPECIES = 5  # Define the cap

    for index, row in tqdm(
        detections_df.iterrows(), total=detections_df.shape[0], desc="Splitting Audio Files", unit="segment"
    ):
        ...
        try:
            ...
            species_segment_counts[species_norwegian_name] = (
